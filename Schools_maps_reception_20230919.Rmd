---
title: "Reception age mapping - 19/09 and 7/12/23"
output: 
  html_document:
    css: Wil_style.css
    theme: default
...
catdiv5B = c('#00429d', '#5681b9', '#93c4d2', '#ffffe0', '#ffa59e', '#dd4c65', '#93003a')
...
# changing the colours in December 
...
Secondary_schools_change_map <- Secondary_schools_geog %>%
  ...
  theme(axis.title.x = element_blank(),
        ...
        axis.ticks.y = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, size=2)) +
  scale_fill_manual("", values =londonmap5_diverge2)+ 
