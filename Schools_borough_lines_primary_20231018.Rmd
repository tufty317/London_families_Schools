---
title: "Schools analysis - Primary and Secondary - 28th November 2023"
output: 
  html_document:
    css: Wil_style.css
    theme: default
...
London_schools_agg_ind2009_lines <- agg_input_london_primary_schools %>%
 ...
 # scale_y_continuous(breaks = seq(88, 102, 2)) + #, limits = c(88, 102)) +
 scale_color_manual(name='Zone:', values = rev(catcolour2)) +
  labs(title= "State-funded full-time primary school pupils by Zone, London, 2009 - 2022, indexed to 2009", 
       caption = paste0("Source: ONS, Chart: GLA demography"))
...
London_orNot_ind2009_lines <- London_orNot %>%
 ...
 scale_colour_manual(values=c("purple", "green"), 
                       name="Zone") +
labs(title= "State-funded full-time primary school pupils, 2009 - 2022, indexed to 2009", 
       caption = paste0("Source: ONS, Chart: GLA demography"))
...
LondonZone_orNot_ind2009_lines <-
   ggplot() +
  theme_gla() +
  geom_line(data = Inner_London_schools_agg_ind2009, aes(x = period_start, y = indexed_headcount, group = 1, color = '#e41a1c' ) ) +
    geom_line(data = Outer_London_schools_agg_ind2009, aes(x = period_start, y = indexed_headcount, group = 1,color = '#377eb8') ) +
   geom_line(data = RestofEng_ind2009, aes(x = period_start, y = indexed_headcount, group = 1, color = "green")) +
  geom_hline(yintercept=100)+
   theme(plot.title = element_text(size = 16, hjust = 0.5)) +
  theme(legend.position = "right") +
   scale_color_manual(name="Legend:", values=c( '#377eb8','#e41a1c' ,"green"), labels=c("Outer London", "Inner London", "Rest of England")) +
   labs(title= "State-funded full-time primary school pupils, 2009 - 2022, indexed to 2009",
       caption = paste0("Source: ONS, Chart: GLA demography"))
LondonZone_orNot_ind2009_lines
...
# ggsave (filename = (paste0(chart_dir, "LondonZone_orNot_ind2009_lines.png")),
...
London_sec_schools_agg_ind2009_lines <- agg_input_london_secondary_schools %>%
 ...
 # scale_y_continuous(breaks = seq(88, 102, 2)) + #, limits = c(88, 102)) +
 scale_color_manual(name='Zone:', values = rev(catcolour2)) +
  labs(title= "State-funded full-time secondary school pupils by Zone, London, 2009 - 2022, indexed to 2009", 
       caption = paste0("Source: ONS, Chart: GLA demography"))
...
region_ind2009_lines <- region_secondary_schools %>%
 ...
 # scale_y_continuous(breaks = seq(88, 102, 2)) + #, limits = c(88, 102)) +
 scale_color_manual(name='Zone:', values = my_pal) +
  labs(title= "State-funded full-time secondary school pupils, by region of England, 2009 - 2022, indexed to 2009", 
       caption = paste0("Source: ONS, Chart: GLA demography"))
region_ind2009_lines
...
London_orNot_ind2009_lines <- London_orNot %>%
 ...
 scale_colour_manual(values=c("purple", "green"), 
                       name="Zone") +
labs(title= "State-funded full-time secondary school pupils, 2009 - 2022, indexed to 2009", 
       caption = paste0("Source: ONS, Chart: GLA demography"))
London_orNot_ind2009_lines
